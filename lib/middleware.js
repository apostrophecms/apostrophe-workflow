...
module.exports = function(self, options) {
  ...
  //
  // Store the locale in a cookie as well.
  ...
  self.expressMiddleware = {
    ...
    middleware: function(req, res, next) {
      ...
      function setLocale(locale) {
        ...
        // Writing the locale to a cookie can be disabled at project level
        if (self.options.noLocaleCookie) {
          return;
        }

        var cookieName = self.apos.shortName + '.locale';
