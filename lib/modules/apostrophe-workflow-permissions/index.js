  ...
  construct: function(self, options) {
    ...
    self.workflowAddPermissions = function() {
      self.add({
        ...
        description: 'Allows users to view content in private locales, such as a "default" locale that is not accessible to the public. Recommended for all groups that contribute content.'
      });
    };
