...
module.exports = {
  ...
  beforeConstruct: function(self, options) {
    options.removeWhenLive = [ 'apostrophe-pages', 'apostrophe-tags', 'apostrophe-workflow-manage-modal' ].concat(options.removeWhenLive || []);
  },
  construct: function(self, options) {
    ...
    self.itemIsVisible = function(req, item) {
      ...
      if (_.contains(self.options.removeWhenLive, item.name)) {
        return false;
      }
