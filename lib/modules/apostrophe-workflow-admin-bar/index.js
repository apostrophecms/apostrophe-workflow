...
module.exports = {
  ...
  baseSafeLiveDenyList: [ 'apostrophe-pages', 'apostrophe-tags', 'apostrophe-workflow-manage-modal' ],
  construct: function(self, options) {
    ...
    self.itemIsVisible = function(req, item) {
      ...
      var safeLiveDenyList = self.options.baseSafeLiveDenyList;
      if (self.options.safeLiveDenyList) {
        safeLiveDenyList = safeLiveDenyList.concat(self.options.safeLiveDenyList);
      }
      if (_.contains(safeLiveDenyList, item.name)) {
        return false;
      }
