  ...
  construct: function(self, options) {
    ...
    self.stylesheetsHelper = function(scene) {
      ...
      if (workflow.locales[locale].stylesheet) {
        ...
        result = '<link href="' + prefix + '/workflow-default-stylesheet?generation=' + self.generation + '" rel="stylesheet" />';
      }
    ...
    self.workflowSendStylesheet = function(req, stylesheet) {
      ...
      // Cache for one year, this is safe because the
      // asset generation ID is included in the query string
      // of the URL, busting the cache automatically on new deploys
      req.res.set('Cache-Control', 'public, max-age=31536000');
