  ...
  construct: function(self, options) {
    ...
    self.beforeShow = function(callback) {
      ...
      self.link('apos-workflow-force-export-related', function() {
        self.forceExportingRelated = true;
        return self.save(function(err) {
          if (err) {
            self.forceExportingRelated = false;
    ...
    self.afterSave = function(callback) {
      ...
      if (self.forceExportingRelated) {
        return apos.modules['apostrophe-workflow'].forceExportRelated(self.savedPage._id, callback);
      }
