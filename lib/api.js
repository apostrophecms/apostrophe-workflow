...
module.exports = function(self, options) {
  ...
  //
  // This method emits the `apostrophe-workflow:resolveRelationships` promise event,
  // giving other modules a chance to further modify `doc`. The arguments
  // to the handler will be `(req, doc, toLocale)`.
  ...
  self.resolveRelationships = function(req, doc, toLocale, callback) {
    ...
    function promiseEvent(callback) {
      console.log('emitting event for ' + doc._id);
