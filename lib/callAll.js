      ...
      return async.eachSeries(missingLocales, function(locale, callback) {
        ...
        function insert(callback) {
          ...
          function beforeInsert(callback) {
            return self.apos.pages.beforeInsert(req, _doc, options, callback);
          }
          function beforeSave(callback) {
            return self.apos.pages.beforeSave(req, _doc, options, callback);
          }
          function insertDoc(callback) {
            return self.apos.docs.insert(req, _doc, options, callback);
          }
        }
