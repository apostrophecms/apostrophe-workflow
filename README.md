...
- [Using the localization feature](#using-the-localization-feature)
  ...
  - [Switching locales via custom hostnames and/or prefixes](#switching-locales-via-custom-hostnames-andor-prefixes)
    - [Example](#example)
    - [Default locales for individual hostnames](#default-locales-for-individual-hostnames)
...
- [Other developer concerns](#other-developer-concerns)
  ...
  - [Workflow event hooks](#workflow-event-hooks)
...
- [Additional options](#additional-options)
  ...
  - [`forceExportExistingRelatedDocuments`](#forceexportexistingrelateddocuments)
